...
def user_posts(username):
    ...
    user = User.query.filter_by(username=username).first_or_404()#either grab that user page or return 404
    blog_posts = BlogPost.query.filter_by(author=user).order_by(BlogPost.date.desc()).paginate(page=page, per_page=5)
    
    #paginate allows us to have pages 5 is  the no. of blogposts per page
